 $(document).ready(function(){
    ...
    "sAjaxSource": "/_server_data"
      ...
      {column_number : 4, date_format: "mm/dd/yyyy", filter_type: "range_date", filter_delay: 500},
      {column_number : 5, column_data_type: "html", html_data_type: "text", filter_default_label: "Select tag"}]);

   var btnFilter = $('.button-filter'),
       classFilter = 'yadcf-filter-wrapper',
       wrapFilter = $("." + classFilter),
       btnClose = $("<div class='button-close'>");

    
    btnFilter.on("click", function() {
      var self = $(this),
        currentWrap = self.next().prepend(btnClose),
        currentSelect = self.next().find(".yadcf-filter");
      
      if (wrapFilter.hasClass("show")) {
        wrapFilter.removeClass("show").addClass("hide");  
        btnFilter.removeClass("hide").addClass("show");  
      }
      
      self.removeClass("show").addClass("hide");
      currentWrap.removeClass("hide").addClass("show");
      
      // if (currentSelect.hasClass("inuse")) {
